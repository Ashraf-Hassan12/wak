                        ...
                        <div class="ibox">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 form-group">
                                        <label>Date</label>
                                        <input class="form-control" name="date" required type="date" value="<?php echo date('Y-m-d'); ?>">
                                    </div>
                                </div>
...
if(isset($_POST['btn'])) {
    ...
    $insert = mysqli_query($conn, "INSERT INTO users (id, 	emp_id, username, password, image, regdate) VALUES (NULL, '$fname', '$uname', '$pass', '$img', '$date')");
